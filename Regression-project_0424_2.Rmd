...
```{r}
p <- 7
n <- nrow (model.matrix(lmod))
qt(1-.05 /(n*2),n-p)
```
```{r}
which(abs(stud) > qt(1-.05/(n*2),n-p))
```
```{r}
subsetdf <- df[c(-10, -19, -221, -488, -573, -583, -1205, -1242, -1423, -1556, -142, -331, -396, -403, -823, -847, -971, -1059, -1418, -1490),]
